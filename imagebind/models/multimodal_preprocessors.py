...
def interpolate_pos_encoding(
    ...
    ), f"Interpolation of pos embed not supported for non-square layouts. You are encountering this because: CLS toke is {first_patch_idx} and npatch_per_img is {npatch_per_img}, and pos_embed.shape is {pos_embed.shape}"
...
class PatchEmbedGeneric(nn.Module):
    ...
    def get_patch_layout(self, img_size):
        ...
        num_patches = patches_layout[0] * patches_layout[1]
...
class RGBDTPreprocessor(VerboseNNModule):
    ...
    def tokenize_input_and_cls_pos(self, input, stem, mask):
        # tokens is of shape B x L x D; 128, 198 --> 1334, 768
        tokens = stem(input)
