...
class ImageBindModel(nn.Module):
    ...
    def forward(self, inputs):
        ...
        for modality_key, modality_value in inputs.items():
            ...
            if modality_value is not None:
                ...
                import ipdb; ipdb.set_trace()
                modality_value = self.modality_trunks[modality_key](**trunk_inputs) # torch.Size([3, 229, 768])
    ...
    def forward_audio(self, audio):
        ...
        '''
        modality_key = ModalityType.AUDIO
        # modality_value = audio[modality_key]
        modality_value = audio
        ...
        modality_value = self.modality_trunks[modality_key](**trunk_inputs) # torch.Size([1, 229, 768])
        ...
        outputs = modality_value
        return outputs

class ImageBindAudioEmbedding(ImageBindModel):
    def __init__(
        self,
        video_frames=2,
        kernel_size=(2, 14, 14),
...
def imagebind_audio(pretrained=False):
