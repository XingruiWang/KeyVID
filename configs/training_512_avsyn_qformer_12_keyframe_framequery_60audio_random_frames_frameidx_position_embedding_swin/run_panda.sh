...
# args
name="training_512_avsyn_qformer_12_keyframe_framequery_60audio_random_frames_frameidx_position_embedding_swin"
config_file=configs/${name}/config_panda.yaml

# save root dir for logs, checkpoints, tensorboard record, etc.
save_root="save/panda"
