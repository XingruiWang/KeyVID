...
# config_file=configs/${name}/config_the_greatest_hits_12.yaml
config_file=configs


# save root dir for logs, checkpoints, tensorboard record, etc.
save_root="save/asva_12_kf_the_greatest_hits"
...
--nproc_per_node=$HOST_GPU_NUM --nnodes=1 --master_addr=127.0.0.1 --master_port=12332 --node_rank=0 \
./main/trainer.py \
--base $config_file \
--train \
--name $name \
