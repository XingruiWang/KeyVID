...
input_root = '/dockerx/local/repo/DynamiCrafter/save/training_512_avsyn_qformer_finetune/samples/'
...
output_root = '/dockerx/local/repo/DynamiCrafter/save/training_512_avsyn_qformer_finetune/samples_interpolated/'
