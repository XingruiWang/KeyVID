...
class ImageLogger(Callback):
    ...
    def log_to_tensorboard(self, pl_module, batch_logs, filename, split, save_fps=6):
    # def log_to_tensorboard(self, pl_module, batch_logs, filename, split, save_fps=12):
        ...
        for key in batch_logs:
            ...
            if isinstance(value, list) and isinstance(value[0], str):
                ...
                pl_module.logger.experiment.add_audio(tag, audio, sample_rate=16000, global_step=global_step)
    ...
    def log_batch_imgs(self, pl_module, batch, batch_idx, split="train"):
        ...
        skip_freq = self.batch_freq if split == "train" else 10
